...
export const weekends: Weekend[] = [
  ...
  },
  {
    ...
    friday: [
      ...
      { time: '10:00',
        title: 'Information Theory — Entropy & Kullback–Leibler Divergence',
        type: 'lecture',
        who: 'Matina',
        links: [
  ...
  },
  {
    ...
    friday: [
      ...
      { time: '12:00', title: 'LLM Transformation Attacks (fine-tuning, quantization, abliteration)', type: 'lecture', who: 'Adrian', url: 'https://raw.githubusercontent.com/eth-fdd-fs26/FDD-WE3-public/main/lectures/03_LLM_Transformation_Attacks.pdf' },
      { time: '13:00', title: 'Lunch break', type: 'break' },
    ...
    saturday: [
      ...
      { time: '10:00', title: 'Coffee break', type: 'break' },
      { time: '10:30', title: 'LLM Watermarks', type: 'lecture', who: 'Konstantinos', url: 'https://raw.githubusercontent.com/eth-fdd-fs26/FDD-WE3-public/main/lectures/06_watermarking.pdf' },
    ...
    resources: [
      ...
      },
      {
        ...
        url: 'https://raw.githubusercontent.com/eth-fdd-fs26/FDD-WE3-public/main/lectures/06_watermarking.pdf',
      },
      {
        group: 'Lecture slides',
      ...
      {
        group: 'Exercises',
        label: 'LLM Defenses (RAG Poisoning Defense)',
        url: 'https://colab.research.google.com/github/eth-fdd-fs26/FDD-WE3-public/blob/main/exercises/05a_rag_poison_defense_student.ipynb',
      },
      {
        group: 'Exercises',
    ...
    friday: [
      {
        ...
        who: 'Suei-Wen',
        links: [
          { label: 'Slides', url: 'https://raw.githubusercontent.com/eth-fdd-fs26/FDD-WE4-public/main/1_rl_intro/lecture/FDD26-W4-ReIntroToRL.pdf' },
          { label: 'Gradient Update Visualization (Download and open in browser)', url: 'https://github.com/eth-fdd-fs26/FDD-WE4-public/blob/main/1_rl_intro/lecture/gradient_update_visualization.html'},
        ],
      },
      { 
        time: '09:00', 
      ...
      { 
        ...
        type: 'exercise',
        links: [
          {label: 'a) Actor-Critic', url: 'https://colab.research.google.com/github/eth-fdd-fs26/FDD-WE4-public/blob/main/3_actor_critic/exercise/03_actor_critic_student.ipynb' },
          {label: 'b) N-step Advantage', url: 'https://colab.research.google.com/github/eth-fdd-fs26/FDD-WE4-public/blob/main/3_actor_critic/exercise/03b_actor_critic_nstep_advantage_student.ipynb' },
        ]
      },
      {
        time: '15:00',
      ...
      { time: '15:30', title: 'Coffee break', type: 'break' },
      {
        ...
        type: 'exercise',
        links: [
          { label: 'PPO on LunarLander (Colab)', url: 'https://colab.research.google.com/github/eth-fdd-fs26/FDD-WE4-public/blob/main/4_gae_ppo/exercise/04_ppo_student.ipynb' },
        ],
      },
    ],
    saturday: [
  ...
  },
  {
    ...
    project: 'Project RAG',
    summary:
      'Building retrieval systems end to end: the RAG pipeline, embeddings and chunking, approximate nearest neighbour and hybrid search, reranking and context engineering, multimodal RAG, agentic and graph RAG, and how to evaluate the result.',
    fridayRoom: 'HG D 7.1',
    saturdayRoom: 'HG D 7.1',
    friday: [
      {
  ...
  },
  {
    ...
    theme: 'Reasoning, Planning and multi-agent systems',
    dates: '21–22 August 2026',
    startISO: '2026-08-21',
    category: 'mandatory',
    project: 'Project Agentic',
    summary:
      'Going deeper into agentic AI: reasoning in LLMs, Language Agent Tree Search (LATS) and multi-agent systems',
    fridayRoom: 'HG D 7.1',
    saturdayRoom: 'HG D 7.1',
    friday: [
      {
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        group: 'Exercises',
        label: 'SLURM',
        url: 'https://colab.research.google.com/github/eth-fdd-fs26/FDD-WE7-public/blob/main/1_slurm_scheduling/FDD-WE7-public/blob/main/exercise/03_slurm_scheduling_student.ipynb',
      },
      {
        group: 'Exercises',
