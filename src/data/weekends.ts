...
export const weekends: Weekend[] = [
  {
    ...
    summary:
      'An optional, hands-on warm-up weekend covering the practical Python stack used throughout the course — NumPy, scikit-learn, PyTorch, Pandas and visualization — so everyone starts from a common foundation.',
    friday: [
      { time: '08:00', title: 'Numpy Matrix and Vector Operations', type: 'lecture', who: 'Carlos' },
      { time: '09:00', title: 'Mini Recommender System', type: 'exercise' },
      ...
      { time: '14:00', title: 'Customer Churn Avoidance', type: 'exercise' },
      { time: '15:00', title: 'Coffee break', type: 'break' },
      { time: '15:30', title: 'PyTorch NNs, Tensors + NN Visualization', type: 'lecture', who: 'Dimitrios' },
      { time: '16:00', title: 'Coding Exercise', type: 'exercise' },
    ],
    saturday: [
      { time: '08:00', title: 'PyTorch Part 2: Specifics + Useful Libraries', type: 'lecture', who: 'Juan' },
      { time: '09:00', title: 'PyTorch Part 2', type: 'exercise' },
      { time: '10:00', title: 'Coffee break', type: 'break' },
      { time: '10:30', title: 'Types of Visualization + Dataframes (Pandas)', type: 'lecture', who: 'Adrian' },
